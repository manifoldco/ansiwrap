...
Manifold's ansiwrap is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/ansiwrap), either for an
